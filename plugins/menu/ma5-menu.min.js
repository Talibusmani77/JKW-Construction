function ma5menu(e) {
  ...
  if ((void 0 !== e.footer && (t = e.footer), $(a).length > 0)) {
    $(a).after(
      '\n\x3c!-- ma5-mobile-menu generated by js start --\x3e\n<nav id="js-ma5menu" class="ma5menu" itemscope itemtype="http://schema.org/SiteNavigationElement">\n    <div class="ma5menu__header">\n        <a class="ma5menu__home" href="index.html" tabindex="-1">\n            <span class="ma5menu__logo"></span>\n        </a>\n        <a class="ma5menu__toggle" tabindex="-1">\n            <span class="ma5menu__close"></span>\n        </a>\n    </div>\n</nav>\n\x3c!-- ma5-mobile-menu generated by js end --\x3e'
    ),
      $(a).clone().attr("id", "js-ma5menu-list").appendTo("#js-ma5menu");
    var r = $("#js-ma5menu-list");
    ma5menuBuilder_clearHTML(r),
      ma5menuBuilder_clearAttributes(r, n),
      ma5menuBuilder_buildActive(r, n),
      ma5menuBuilder_buildLevels($(r), 0, "ma5-ul");
  }
  if ($(".ma5menu").length > 0) {
    var l = "left";
    "right" === e.position && (l = e.position),
      ...
      $(t).length > 0 &&
        $(".ma5menu__panel").append(
          '<div class="ma5menu__footer js-append">' + $(t).html() + "</div>"
        ),
...
function ma5menuBuilder_clearAttributes(e, a) {
  ...
  $(r).each(function () {
    ...
    $(t).each(function () {
      for (
        var e = $(this).is("." + a), t = this.attributes, r = t.length;
        r--;
...
function ma5menuBuilder_clearHTML(e) {
  ...
  a.each(function () {
    $(this).unwrapUntil("li"),
      a.find("> b, > strong, > span, > div, > i").replaceWith(function () {
...
function ma5menuBuilder_buildActive(e, a) {
  var n = $(e).find("." + a);
  if (0 === n.length)
    $(e).attr("data-ma5order", "ma5-ul").addClass("ma5menu__panel--active");
  else {
    ...
    n.each(function () {
      ...
      if ("A" === this.tagName)
        for (
          $(this)
            .parent()
            .addClass("ma5menu__li--current")
            .parent()
            .addClass("ma5menu__panel--active"),
            $(this).addClass("ma5menu__path");
          t--;

        )
          (e = e.parent().parent()), e.find("> a").addClass("ma5menu__path");
      if ("LI" === this.tagName)
        for (
          $(this)
            .addClass("ma5menu__li--current")
          ...
          (e = e.parent()), e.find("> a").addClass("ma5menu__path");
    });
  }
  $("#js-ma5menu")
    .find("." + a)
    ...
    r.each(function () {
      ...
      if (n.length > 0) {
        ...
        $(this)
          ...
          .prepend(
            '<div class="ma5menu__leave"><span class="ma5menu__btn--leave"></span>' +
              t +
              "</div>"
          ),
          $('<span class="ma5menu__btn--enter"></span>').insertBefore(
            $(this).find("> a")
          );
...
isIE()
  ...
  detectSafari() && (htmlRootForDetectBrowser.className += " safari"),
